...
public class SavvyConsumerSpeechlet implements Speechlet {
    ...
    public SpeechletResponse onLaunch(final LaunchRequest request, final Session session)
        ...
        String repromptText = "Please choose a category by saying, books <break time=\"0.2s\" />"
                + "fashion <break time=\"0.2s\" /> movie <break time=\"0.2s\" /> kitchen";
    ...
    private SpeechletResponse getTopSellers(final Intent intent, final Session session)
        ...
        if (lookupCategory != null) {
            ...
            SpeechletResponse response = newAskResponse("<speak>" + speechOutput.toString() + "</speak>",
            ...
            repromptText =
                    "I'm not sure what the category is, you can say "
                            + "books <break time=\"0.2s\" /> fashion <break time=\"0.2s\" />"
                            + "movie <break time=\"0.2s\" /> kitchen.";
            return newAskResponse("<speak>" + speechOutput + "</speak>", "<speak>" + repromptText + "</speak>");
        }
    }
    ...
    private SpeechletResponse getNextPageOfItems(final Intent intent, final Session session) {
        if (session.getAttributes().containsKey(SESSION_CURRENT_INDEX)) {
            int currentIndex = (int) session.getAttribute(SESSION_CURRENT_INDEX);
            ...
            if (currentIndex < MAX_ITEMS) {
                ...
                return newAskResponse("<speak>" + speechOutput.toString() + "</speak>",
                        "<speak> Would you like to hear more top sellers? Please say yes or no. </speak>");
            } else {
                SsmlOutputSpeech output = new SsmlOutputSpeech();
    ...
    private SpeechletResponse getHelp() {
        ...
        String repromptText =
                "I'm sorry I didn't understand that. You can say things like, books <break time=\"0.2s\" />"
                        + " movies <break time=\"0.2s\" /> music. "
