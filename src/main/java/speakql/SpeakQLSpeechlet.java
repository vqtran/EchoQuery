...
/**
 * Ask for certain pieces of information and SpeakQL will translate it into an SQL query.
 * 
 */
public class SpeakQLSpeechlet implements Speechlet {
    private static final Logger log = LoggerFactory.getLogger(SpeakQLSpeechlet.class);
    ...
    public SpeechletResponse onIntent(final IntentRequest request, final Session session)
        ...
        if ("TableAggregateIntent".equals(intentName)) {
            return handleAggregateIntent(intent, session);
     ...
     * @return SpeechletResponse object with voice/card response to return to the user
     */
    private SpeechletResponse TableAggregateIntent(Intent intent, Session session) {
